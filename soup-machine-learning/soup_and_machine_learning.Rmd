...
In this post, I'm going to make the claim that we can simplify some parts of the machine learning process by using the analogy of making soup. I think this analogy can both simplify how a data scientist explains machine learning to a broad audience, and it provides a helpful framework throughout the model building process.
...
Let's see this framework in action. I'm going to pick a fairly simple classification task to demonstrate. I'm going to use the [iris dataset](https://en.wikipedia.org/wiki/Iris_flower_data_set) and try to predict whether a flower is from the setosa species.
