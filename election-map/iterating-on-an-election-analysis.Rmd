...
What would the previous residual map look like if we controlled for factors like education, income, and age? I'm also going to add in the two party ratio from the 2012 election (which came from [this GitHub repository](https://github.com/tonmcg/US_County_Level_Election_Results_08-16)).
...
A few things are __noticeably different__ between the two maps:
  ...
  - Adding variables to the model substantially improved the fit. Notice how the range for our color palette is now much smaller.
