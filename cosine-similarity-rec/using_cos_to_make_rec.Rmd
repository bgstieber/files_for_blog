...
You may be wondering what $a$ and $b$ actually represent. If we're trying to recommend certain products, $a$ and $b$ might be the collection of user ratings for each of the products. If we have three customers, $a =[5, 0, 1]$ and $b = [0, 1, 2]$, meaning that the first customer rated $a$ a 5 and did not rate $b$, the second customer did not rate $a$ and gave $b$ a 1, and the third customer rated $a$ a 1 and $b$ a 2. So $a$ and $b$ are vectors which collect information about the items of interest in our analysis.
