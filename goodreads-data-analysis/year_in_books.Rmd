...
One thing that's missing from the Goodreads data export is the description of the book. I wrote a [python script]() that uses BeautifulSoup to scrape Goodreads for this information. I don't use it in _this post_, but I could see using it in a different post down the road.
