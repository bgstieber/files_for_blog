...
I also used the Goodreads data to set a reasonable stretch goal for 2021. I hope to increase my reading by `r percent((ceiling(365/days_to_read.gb) - 30) / 30)` in 2021 by finishing `r ceiling(365/days_to_read.gb)` books.

This was a fun way to look back on my year in books for 2020. There are a few others that I could look into like the distribution of genres, the text summary of the book, and text reviews from other Goodreads users. That analysis will have to wait for another day!
